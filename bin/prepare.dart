...
Map<String, String Function(String)> _flutterCreateFixes(
  ...
  'linux/runner/my_application.cc': (s) => s
      ...
      .replaceAllIf(package.portrait, 'window, 1280, 720', 'window, 405, 720'),
  ...
  if (package.portrait)
    'macos/Runner/Base.lproj/MainMenu.xib': (s) =>
        s.replaceAll('width="800" height="600"', 'width="450" height="600"'),
